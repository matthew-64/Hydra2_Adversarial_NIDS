...
class TestSuite:
    ...
    def run_test(self):
        ...
        if str(self.network_attack) == "SYN Flood":
            if str(self.adversarial_attack) == "Standard":
                acc, result = self.standard_syn_flood(1000, 1500)
            ...
            elif str(self.adversarial_attack) == "Evasion: Payload+Rate+Pairflow":
    ...
    def calc_acc(self, src_eth, dst_eth, stealth):
        ...
        # TODO: add a time.sleep to make sure intrusion detection is finished
        time.sleep(15)
